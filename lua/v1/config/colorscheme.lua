...
hl("@type", { link = "Type" })
hl("@type.builtin", { fg = colors.fg2 })
hl("@type.definition", { fg = colors.fg2 })
...
hl("@lsp.type.interface", { fg = colors.fg2, italic = true })
...
hl("CmpItemKindClass", { fg = colors.fg2 })
hl("CmpItemKindInterface", { fg = colors.fg2, italic = true })
hl("CmpItemKindModule", { fg = colors.fg2 })
hl("CmpItemKindStruct", { fg = colors.fg2 })
hl("CmpItemKindEnum", { fg = colors.fg2 })
